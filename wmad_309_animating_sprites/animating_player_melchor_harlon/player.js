class Player {
    ...
    draw(){
        this.currentFrame = this.currentFrame < this.actionFrames["03_explode"].frameCount
            ? this.currentFrame : 0;
        this.ctx.drawImage(this.actionFrames["03_explode"].frames[this.currentFrame++], 100, 75, this.width, this.height);
    }
}
